...
public class FirstJava {
	//coding in the class and calling it
	
public static void main(String[] args) {
		// Learning how to code at the middle of the nignt
		// coding is fun
	            String firstName = "Daniel";
	            String lastName = "Dabbo";
	            int Age = 36;
	            String address = "1836 adams street";
	            String city = "Tucker";
	            String state = "Ga";
	            int postalcode = 30019;
